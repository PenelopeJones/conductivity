...
def main(args):
    ...
    if not os.path.exists(pts + 'predictions/correlation_functions/temporal/220513/'):
    ...
    np.save(pts + 'predictions/correlation_functions/temporal/220513/tcf1_n_{}_{}'.format(conc, lb).replace('.', '-') + '.npy', tcf1_n)
    np.save(pts + 'predictions/correlation_functions/temporal/220513/tcf1_p_{}_{}'.format(conc, lb).replace('.', '-') + '.npy', tcf1_p)
    np.save(pts + 'predictions/correlation_functions/temporal/220513/tcf2_n_{}_{}'.format(conc, lb).replace('.', '-') + '.npy', tcf2_n)
    np.save(pts + 'predictions/correlation_functions/temporal/220513/tcf2_p_{}_{}'.format(conc, lb).replace('.', '-') + '.npy', tcf2_p)
